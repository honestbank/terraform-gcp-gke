...
| <a name="input_firewall_allow_ports_control_plane_to_node_pool"></a> [firewall\_allow\_ports\_control\_plane\_to\_node\_pool](#input\_firewall\_allow\_ports\_control\_plane\_to\_node\_pool) | List of ports to allow K8 Control plane to communicate with nodepool | `list(string)` | `[]` | no |
