...
#  variable = "Enable or disable cluster autoscaling. If enabled, cluster_autoscaling_cpu_* and cluster_autoscaling_memory_* variables are required."
#}
#
#variable "cluster_autoscaling_cpu_maximum_cores" {
#  description = "The value to set in the cluster_autoscaling.resource_limits.maximum block for resource_type = cpu. Ignored if cluster_autoscaling_enabled = false."
#}
#
#variable "cluster_autoscaling_cpu_miniumum_cores" {
#  description = "The value to set in the cluster_autoscaling.resource_limits.minimum block for resource_type = cpu. Ignored if cluster_autoscaling_enabled = false."
#}
#variable "cluster_autoscaling_memory_maximum_gb" {
#  description = "The value to set in the cluster_autoscaling.resource_limits.maximum block for resource_type = memory. Ignored if cluster_autoscaling_enabled = false."
#}
#
#variable "cluster_autoscaling_memory_miniumum_gb" {
#  description = "The value to set in the cluster_autoscaling.resource_limits.minimum block for resource_type = memory. Ignored if cluster_autoscaling_enabled = false."
#}
...
variable "shared_vpc_host_google_project" {
  description = "The GCP project that hosts the VPC to place the GKE cluster in - can be an in-project VPC or a shared VPC. In the case of a shared VPC, "
}
